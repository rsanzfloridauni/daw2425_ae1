...
$palabras = ['elefante', 'jirafa', 'hipopotamo', 'rinoceronte', 'cocodrilo', 'camello', 'chimpance', 'unicornio', 'olifante'];
...
<body>
    <div class="container">
        ...
        <p class="letras-usadas">Letras usadas: <?php echo implode(', ', $_SESSION['letras_usadas']); ?></p>
    </div>
</body>
</html>
